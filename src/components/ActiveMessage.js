...
class ActiveMessage extends Component {
  ...
  componentDidMount() {
    // this.props.activeMessage ? this.setState({ activeMessage }) : "";
    if (this.props.handle === "edit") {
      // console.log(this.props.activeMessage);
      this.setState({ activeMessage: this.props.activeMessage });
    }
  }
    ...
    return (
      <div>
        ...
        >
          ...
          {/* 保证金支付方式 */}
          <div>
            <label className="inputTitle">保证金支付方式</label>
          ...
          <div>
            ...
            <input
              ...
              id="bondTook"
              type="radio"
              checked={this.state.activeMessage.bondTo}
            />
